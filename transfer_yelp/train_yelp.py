...
from models_yelp import Seq2Seq2Decoder, Seq2Seq, MLP_D, MLP_G, MLP_Classify
import shutil
import logging
...
def train_gan_g():
    ...
    noise.data.normal_(0, 1)
    fake_hidden = gan_gen(noise)
    # errG = gan_disc(fake_hidden)  # w2
    errG = torch.exp(gan_disc(fake_hidden))  # kl
    errG.backward(mone)
